...
import SpideyImage from "../assets/spidey.png"; // Path to your Spidey PNG

const Hero = () => {
  return (
    <section
      id="home"
      className="relative h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white flex items-center justify-center overflow-hidden font-comic"
    >
      ...
      >
        ...
        <a
          href="#projects"
          className="inline-block mt-6 px-6 py-3 bg-[#378bb8] text-white font-bold border-[3px] border-black rounded-full shadow-[4px_4px_0_#000] hover:scale-105 transition-transform"
        >
          View My Work
        </a>
      </motion.div>

      {/* Spidey Image Hanging from Navbar */}
